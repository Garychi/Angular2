...
var DynamicFormValueControlModel = (function (_super) {
    ...
    function DynamicFormValueControlModel(config, cls) {
        ...
        _this.asyncValidators = utils_1.getValue(config, "asyncValidators", null);
        _this.errorMessages = utils_1.getValue(config, "errorMessages", null);
        _this.hint = utils_1.getValue(config, "hint", null);
        _this.required = utils_1.getValue(config, "required", false);
        _this.tabIndex = utils_1.getValue(config, "tabIndex", null);
        _this.validators = utils_1.getValue(config, "validators", null);
        _this._value = utils_1.getValue(config, "value", null);
        _this.valueUpdates = new Subject_1.Subject();
