...
var dynamic_check_control_model_1 = require("../dynamic-check-control.model");
...
var DynamicSwitchModel = (function (_super) {
    ...
    function DynamicSwitchModel(config, cls) {
        ...
        _this.type = exports.DYNAMIC_FORM_CONTROL_TYPE_SWITCH;
        _this.offLabel = utils_1.getValue(config, "offLabel", null);
        _this.onLabel = utils_1.getValue(config, "onLabel", null);
        return _this;
    }
    return DynamicSwitchModel;
}(dynamic_check_control_model_1.DynamicCheckControlModel));
__decorate([
