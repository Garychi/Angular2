...
var DynamicTextAreaModel = (function (_super) {
    ...
    function DynamicTextAreaModel(config, cls) {
        ...
        _this.type = exports.DYNAMIC_FORM_CONTROL_TYPE_TEXTAREA;
        _this.cols = utils_1.getValue(config, "cols", 20);
        _this.rows = utils_1.getValue(config, "rows", 2);
        _this.wrap = utils_1.getValue(config, "wrap", exports.DYNAMIC_FORM_TEXTAREA_WRAP_SOFT);
        return _this;
    }
