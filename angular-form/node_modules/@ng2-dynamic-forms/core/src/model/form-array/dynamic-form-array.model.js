...
var DynamicFormArrayGroupModel = (function () {
    ...
    DynamicFormArrayGroupModel.prototype.toJSON = function () {
        return serializable_decorator_1.serialize(this);
    };
...
var DynamicFormArrayModel = (function (_super) {
    ...
    function DynamicFormArrayModel(config, cls) {
        ...
        _this.groups = [];
        _this.type = exports.DYNAMIC_FORM_CONTROL_TYPE_ARRAY;
        if (!utils_1.isFunction(config["createGroup"])) {
            throw new Error("createGroup function must be specified for DynamicFormArrayModel");
        }
        _this.asyncValidator = utils_1.getValue(config, "asyncValidator", null);
        _this.createGroup = config["createGroup"];
        _this.initialCount = utils_1.getValue(config, "initialCount", 1);
        _this.originGroup = _this.createGroup();
        _this.validator = utils_1.getValue(config, "validator", null);
