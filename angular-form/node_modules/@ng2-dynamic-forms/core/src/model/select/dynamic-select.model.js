...
exports.DYNAMIC_FORM_CONTROL_TYPE_SELECT = "SELECT";
var DynamicSelectModel = (function (_super) {
    ...
    function DynamicSelectModel(config, cls) {
        ...
        _this.type = exports.DYNAMIC_FORM_CONTROL_TYPE_SELECT;
        _this.multiple = utils_1.getValue(config, "multiple", false);
        return _this;
    }
