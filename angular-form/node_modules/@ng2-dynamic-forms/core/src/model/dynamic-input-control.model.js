...
var DynamicInputControlModel = (function (_super) {
    ...
    function DynamicInputControlModel(config, cls) {
        ...
        _this.autoComplete = utils_1.getValue(config, "autoComplete", dynamic_form_autofill_service_1.AUTOCOMPLETE_ON);
        _this.autoFocus = utils_1.getValue(config, "autoFocus", false);
        _this.maxLength = utils_1.getValue(config, "maxLength", null);
        _this.minLength = utils_1.getValue(config, "minLength", null);
        _this.placeholder = utils_1.getValue(config, "placeholder", "");
        _this.prefix = utils_1.getValue(config, "prefix", null);
        _this.readOnly = utils_1.getValue(config, "readOnly", false);
        _this.spellCheck = utils_1.getValue(config, "spellCheck", false);
        _this.suffix = utils_1.getValue(config, "suffix", null);
        return _this;
    }
