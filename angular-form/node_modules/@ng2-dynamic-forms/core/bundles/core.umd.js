...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/Subject'), require('@angular/core'), require('@angular/forms'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define(['exports', 'rxjs/Subject', '@angular/core', '@angular/forms', '@angular/common'], factory) :
    (factory((global.ng2DF = global.ng2DF || {}, global.ng2DF.core = global.ng2DF.core || {}),global.Rx,global.ng.core,global.ng.forms,global.ng.common));
}(this, (function (exports,rxjs_Subject,_angular_core,_angular_forms,_angular_common) { 'use strict';
...
var DynamicFormValueControlModel = (function (_super) {
    ...
    function DynamicFormValueControlModel(config, cls) {
        ...
        _this.asyncValidators = getValue(config, "asyncValidators", null);
        _this.errorMessages = getValue(config, "errorMessages", null);
        _this.hint = getValue(config, "hint", null);
        _this.required = getValue(config, "required", false);
        _this.tabIndex = getValue(config, "tabIndex", null);
        _this.validators = getValue(config, "validators", null);
        _this._value = getValue(config, "value", null);
        _this.valueUpdates = new rxjs_Subject.Subject();
...
var DynamicInputControlModel = (function (_super) {
    __extends$2(DynamicInputControlModel, _super);
    function DynamicInputControlModel(config, cls) {
        var _this = _super.call(this, config, cls) || this;
        _this.autoComplete = getValue(config, "autoComplete", AUTOCOMPLETE_ON);
        _this.autoFocus = getValue(config, "autoFocus", false);
        _this.maxLength = getValue(config, "maxLength", null);
        _this.minLength = getValue(config, "minLength", null);
        _this.placeholder = getValue(config, "placeholder", "");
        _this.prefix = getValue(config, "prefix", null);
        _this.readOnly = getValue(config, "readOnly", false);
        _this.spellCheck = getValue(config, "spellCheck", false);
        _this.suffix = getValue(config, "suffix", null);
        return _this;
    }
...
var DynamicInputModel = (function (_super) {
    __extends$1(DynamicInputModel, _super);
    function DynamicInputModel(config, cls) {
        var _this = _super.call(this, config, cls) || this;
        _this.files = null;
        _this.listId = null;
        _this.type = DYNAMIC_FORM_CONTROL_TYPE_INPUT;
        _this.accept = getValue(config, "accept", null);
        _this.inputType = getValue(config, "inputType", DYNAMIC_FORM_CONTROL_INPUT_TYPE_TEXT);
        _this.list = getValue(config, "list", null);
        _this.max = getValue(config, "max", null);
        _this.min = getValue(config, "min", null);
        _this.multiple = getValue(config, "multiple", null);
        _this.pattern = getValue(config, "pattern", null);
        _this.step = getValue(config, "step", null);
        if (_this.list) {
...
exports.DynamicIdDirective = (function () {
...
], exports.DynamicIdDirective.prototype, "dynamicId", void 0);
exports.DynamicIdDirective = __decorate$4([
...
var DynamicCheckControlModel = (function (_super) {
    __extends$3(DynamicCheckControlModel, _super);
    function DynamicCheckControlModel(config, cls) {
        var _this = _super.call(this, config, cls) || this;
...
var DynamicOptionControlModel = (function (_super) {
    __extends$4(DynamicOptionControlModel, _super);
    function DynamicOptionControlModel(config, cls) {
        var _this = _super.call(this, config, cls) || this;
        _this.options = config.options ? config.options.map(function (optionConfig) { return new DynamicFormOption(optionConfig); }) : [];
        return _this;
    }
...
var DynamicCheckboxModel = (function (_super) {
    ...
    function DynamicCheckboxModel(config, cls) {
        ...
        _this.align = getValue(config, "align", DYNAMIC_FORM_CONTROL_CHECKBOX_ALIGN_START);
        _this.indeterminate = getValue(config, "indeterminate", false);
        return _this;
    }
...
var DynamicFormGroupModel = (function (_super) {
    __extends$7(DynamicFormGroupModel, _super);
    function DynamicFormGroupModel(config, cls) {
        ...
        _this.asyncValidator = getValue(config, "asyncValidator", null);
        _this.group = getValue(config, "group", []);
        _this.legend = getValue(config, "legend", null);
        _this.validator = getValue(config, "validator", null);
        return _this;
    }
...
var DynamicCheckboxGroupModel = (function (_super) {
    __extends$6(DynamicCheckboxGroupModel, _super);
...
var DynamicFormArrayModel = (function (_super) {
    __extends$8(DynamicFormArrayModel, _super);
    function DynamicFormArrayModel(config, cls) {
        ...
        _this.asyncValidator = getValue(config, "asyncValidator", null);
        _this.createGroup = config["createGroup"];
        _this.initialCount = getValue(config, "initialCount", 1);
        _this.originGroup = _this.createGroup();
        _this.validator = getValue(config, "validator", null);
        if (Array.isArray(config.groups)) {
            ...
            for (var i = 0; i < _this.initialCount; i += 1) {
                _this.addGroup();
            }
        }
        return _this;
...
var DynamicRadioGroupModel = (function (_super) {
    __extends$9(DynamicRadioGroupModel, _super);
...
var DynamicSelectModel = (function (_super) {
    ...
    function DynamicSelectModel(config, cls) {
        ...
        _this.multiple = getValue(config, "multiple", false);
        return _this;
    }
...
var DynamicSliderModel = (function (_super) {
    __extends$11(DynamicSliderModel, _super);
    function DynamicSliderModel(config, cls) {
        var _this = _super.call(this, config, cls) || this;
        _this.type = DYNAMIC_FORM_CONTROL_TYPE_SLIDER;
        _this.min = getValue(config, "min", 0);
        _this.max = getValue(config, "max", 10);
        _this.step = getValue(config, "step", 1);
        _this.vertical = getValue(config, "vertical", false);
        return _this;
    }
...
var __extends$12 = (window && window.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
};
...
var DynamicSwitchModel = (function (_super) {
    __extends$12(DynamicSwitchModel, _super);
    function DynamicSwitchModel(config, cls) {
        var _this = _super.call(this, config, cls) || this;
        _this.type = DYNAMIC_FORM_CONTROL_TYPE_SWITCH;
        _this.offLabel = getValue(config, "offLabel", null);
        _this.onLabel = getValue(config, "onLabel", null);
        return _this;
    }
...
var __extends$13 = (window && window.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
};
...
var DynamicTextAreaModel = (function (_super) {
    __extends$13(DynamicTextAreaModel, _super);
    function DynamicTextAreaModel(config, cls) {
        var _this = _super.call(this, config, cls) || this;
        _this.type = DYNAMIC_FORM_CONTROL_TYPE_TEXTAREA;
        _this.cols = getValue(config, "cols", 20);
        _this.rows = getValue(config, "rows", 2);
        _this.wrap = getValue(config, "wrap", DYNAMIC_FORM_TEXTAREA_WRAP_SOFT);
        return _this;
    }
...
exports.DynamicFormService = (function () {
    function DynamicFormService(formBuilder, NG_VALIDATORS$$1, NG_ASYNC_VALIDATORS$$1) {
    ...
    DynamicFormService.prototype.getValidatorFn = function (validatorName, validatorArgs) {
        var validatorFn = _angular_forms.Validators[validatorName] || this.getCustomValidatorFn(validatorName);
    ...
    DynamicFormService.prototype.createFormGroup = function (group, groupExtra) {
        ...
        group.forEach(function (model) {
            if (model.type === DYNAMIC_FORM_CONTROL_TYPE_ARRAY) {
                ...
                formGroup[valueControlModel.id] = new _angular_forms.FormControl({
                    value: valueControlModel.value,
                    disabled: valueControlModel.disabled
                }, _angular_forms.Validators.compose(_this.getValidators(valueControlModel.validators || [])), _angular_forms.Validators.composeAsync(_this.getValidators(valueControlModel.asyncValidators || [])));
            }
        });
...
exports.DynamicFormService = __decorate$15([
    __param(0, _angular_core.Inject(_angular_forms.FormBuilder)),
    __param(1, _angular_core.Optional()), __param(1, _angular_core.Inject(_angular_forms.NG_VALIDATORS)),
    __param(2, _angular_core.Optional()), __param(2, _angular_core.Inject(_angular_forms.NG_ASYNC_VALIDATORS)),
    __metadata$15("design:paramtypes", [_angular_forms.FormBuilder,
        Array,
        Array])
...
exports.DynamicFormRelationService = (function () {
...
exports.DynamicFormRelationService = __decorate$16([
    _angular_core.Injectable(),
    __metadata$16("design:paramtypes", [])
], exports.DynamicFormRelationService);
...
exports.DynamicFormsCoreModule = DynamicFormsCoreModule_1 = (function () {
    ...
    DynamicFormsCoreModule.forRoot = function () {
        return {
            ...
            providers: [exports.DynamicFormService, DynamicFormAutoFillService, exports.DynamicFormRelationService]
        };
    };
    return DynamicFormsCoreModule;
}());
exports.DynamicFormsCoreModule = DynamicFormsCoreModule_1 = __decorate$17([
    _angular_core.NgModule({
        imports: [_angular_common.CommonModule, _angular_forms.ReactiveFormsModule],
        declarations: [exports.DynamicIdDirective],
        exports: [exports.DynamicIdDirective]
    }),
    __param$1(0, _angular_core.Optional()), __param$1(0, _angular_core.SkipSelf()),
    __metadata$17("design:paramtypes", [exports.DynamicFormsCoreModule])
